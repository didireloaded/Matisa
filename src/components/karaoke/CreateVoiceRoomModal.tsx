      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm rounded-3xl border border-[#2E2822] p-6 shadow-2xl"
            style={{
          ...
          >
            <button
              onClick={onClose}
              className="absolute right-4 top-4 rounded-full p-2 text-[#8A7F74] transition hover:bg-[#2E2822] hover:text-[#F5F0EA]"
            >
              <X size={18} />
            </button>
            ...
            <div className="mb-6 flex flex-col items-center text-center">
              ...
              <h2 className="text-xl font-bold text-[#F5F0EA]">Start a Voice Room</h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  maxLength={40}
                  className="w-full rounded-xl border border-[#2E2822] bg-[#0F0D0B] px-4 py-3 text-sm text-[#F5F0EA] placeholder:text-[#8A7F74] focus:border-[#F44336] focus:outline-none focus:ring-1 focus:ring-[#F44336]"
                />
              </div>
