    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[120] flex items-center justify-center px-4">
        ...
        <motion.div
          ...
          className="relative z-10 w-full max-w-md bg-[#0D1F38] border border-white/15 rounded-[28px] p-6 shadow-2xl space-y-6 max-h-[calc(100dvh-12px)] overflow-y-auto overscroll-contain pb-[calc(24px+env(safe-area-inset-bottom))]"
        >
          <button
            onClick={onClose}
