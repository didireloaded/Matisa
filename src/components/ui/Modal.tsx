    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className={`relative z-10 w-full ${maxW} bg-[var(--color-surface)] border border-[var(--color-border)] rounded-[24px] shadow-2xl flex flex-col max-h-[calc(100dvh-12px)] overflow-y-auto overscroll-contain pb-[calc(16px+env(safe-area-inset-bottom))]`}
        >
          {/* Header */}
          {title && (
