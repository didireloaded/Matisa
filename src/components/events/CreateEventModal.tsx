    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-h-[calc(100dvh-12px)] overflow-y-auto overscroll-contain pb-[calc(24px+env(safe-area-inset-bottom))] sm:max-w-md bg-background rounded-t-3xl flex flex-col border border-border shadow-2xl"
        >
          {/* Header */}
