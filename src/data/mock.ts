import type { Profile, Post, Story, EventItem, Community, Conversation, AppNotification, Opportunity, TrendingItem, Region } from "./types";
...
export const PROFILES: Profile[] = [
  { id: ME_ID, username: "ndina", full_name: "Ndina Shikongo", bio: "Documentary photographer. Windhoek skies.", avatar_url: "", gradient: G.rust, region: "Khomas", city: "Windhoek", mood: "Golden hour chasing", interests: ["Photography","Film","Travel"], creator_badge: "Photographer", is_creator: true, is_verified: false, is_plus: true, followers_count: 1284, following_count: 312, posts_count: 87, song_title: "Beautiful Naita", song_artist: "Big Ben", recent_work: "Standard Bank Namibia Campaign", booking_rate: "N$800/day", ghost_mode: "approximate", online: true },
  { id: "u_tangeni", username: "tangeni_mwetupunga", full_name: "Tangeni Mwetupunga", bio: "Producer. Oshakati to Windhoek.", avatar_url: "", gradient: G.dark, region: "Oshana", city: "Oshakati", mood: "In the studio", interests: ["Music","Tech","Business"], creator_badge: "Musician", is_creator: true, is_verified: true, is_plus: true, followers_count: 8421, following_count: 540, posts_count: 211, distance: 420, bearing: 45, song_title: "Otjijazz", song_artist: "EES", recent_work: "Afrobeats Namibia EP", booking_rate: "N$2500/session", ghost_mode: "approximate", online: true },
  { id: "u_kavetu", username: "himba.diaries", full_name: "Kavetu Tjirare", bio: "Telling Kunene stories. Cinematic Namibia.", avatar_url: "", gradient: G.sand, region: "Kunene", city: "Opuwo", mood: "On the road", interests: ["Film","Photography","Travel"], creator_badge: "Filmmaker", is_creator: true, is_verified: true, is_plus: false, followers_count: 9120, following_count: 122, posts_count: 312, distance: 980, bearing: 110, recent_work: "Mercedes GLC Namibia Campaign", booking_rate: "N$4500/day", ghost_mode: "approximate", online: false },
  { id: "u_sarah", username: "sarah.k_photography", full_name: "Sarah Kavandje", bio: "Portrait and commercial photographer.", avatar_url: "", gradient: G.teal, region: "Khomas", city: "Windhoek", mood: "Shooting today", interests: ["Photography","Fashion","Art"], creator_badge: "Photographer", is_creator: true, is_verified: false, is_plus: false, followers_count: 3240, following_count: 810, posts_count: 156, distance: 2300, bearing: 200, recent_work: "Namibia Fashion Week 2025", booking_rate: "N$1200/day", ghost_mode: "exact", online: true },
  { id: "u_didi", username: "didi_reloaded", full_name: "Didi Reloaded", bio: "Cinematographer. Visual storyteller.", avatar_url: "", gradient: G.purple, region: "Khomas", city: "Windhoek", mood: "Post-production", interests: ["Film","Tech","Music"], creator_badge: "Videographer", is_creator: true, is_verified: true, is_plus: true, followers_count: 12400, following_count: 210, posts_count: 445, distance: 1450, bearing: 280, recent_work: "Mercedes GLC Campaign", booking_rate: "N$6000/day", ghost_mode: "exact", online: true },
  { id: "u_lukas", username: "the.kwaito.kid", full_name: "Lukas Hango", bio: "DJ. Otjiwarongo crowds.", avatar_url: "", gradient: G.green, region: "Otjozondjupa", city: "Otjiwarongo", mood: "Set tonight", interests: ["Music","Cars","Sports"], creator_badge: "DJ", is_creator: true, is_verified: false, is_plus: false, followers_count: 5102, following_count: 890, posts_count: 154, distance: 3400, bearing: 330, recent_work: "Summer Fiesta 2025 Main Stage", booking_rate: "N$3000/night", ghost_mode: "approximate", online: true },
  { id: "u_ester", username: "ester.k", full_name: "Ester Kapuuo", bio: "Swakopmund. Coffee, running, cold Atlantic.", avatar_url: "", gradient: G.sky, region: "Erongo", city: "Swakopmund", mood: "Salty hair", interests: ["Sports","Travel","Food"], is_creator: false, is_verified: false, is_plus: false, followers_count: 945, following_count: 410, posts_count: 64, distance: 4100, bearing: 160, ghost_mode: "hidden", online: false },
  { id: "u_shaun", username: "shaun.garoeb", full_name: "Shaun //Garoeb", bio: "Luderitz. Fish, stars, silence.", avatar_url: "", gradient: G.navy, region: "//Karas", city: "Luderitz", mood: "Stargazing", interests: ["Photography","Travel","Food"], is_creator: false, is_verified: false, is_plus: false, followers_count: 612, following_count: 220, posts_count: 38, ghost_mode: "hidden", online: false },
  { id: "u_panduleni", username: "panduleni_iy", full_name: "Panduleni Iyambo", bio: "Law student. Eenhana born.", avatar_url: "", gradient: G.teal, region: "Ohangwena", city: "Eenhana", mood: "Deadlines", interests: ["Business","Tech","Gaming"], is_creator: false, is_verified: false, is_plus: false, followers_count: 312, following_count: 188, posts_count: 27, ghost_mode: "approximate", online: true },
  { id: "u_helvi", username: "helvi.shilumbu", full_name: "Helvi Shilumbu", bio: "Caprivi-born. Katima river life.", avatar_url: "", gradient: G.green, region: "Zambezi", city: "Katima Mulilo", mood: "River weekend", interests: ["Travel","Food","Photography"], is_creator: false, is_verified: false, is_plus: false, followers_count: 1820, following_count: 612, posts_count: 73, distance: 6200, bearing: 70, ghost_mode: "approximate", online: true },
];
...
export const CONVERSATIONS: Conversation[] = [
  ...
  { id: "cv3", is_group: false, member_ids: [ME_ID, "u_didi"], last_message: "That Mercedes footage is insane", last_message_at: "3h", unread: 0 },
...
export const NOTIFICATIONS: AppNotification[] = [
  ...
  { id: "n4", type: "booking", actor_id: "u_lukas", recipient_id: ME_ID, body: "sent a booking request", when: "2h", bucket: "today", read: false },
  { id: "n5", type: "view", actor_id: "u_tangeni", recipient_id: ME_ID, body: "viewed your creator profile", when: "4h", bucket: "today", read: true },
...
export const OPPORTUNITIES: Opportunity[] = [
  { id: "o1", title: "Photographer Needed", location: "Windhoek", region: "Khomas", date: "Tomorrow", budget: "N$1200", category: "Photographer", posted_by: "u_didi", applicants: 8 },
  { id: "o2", title: "DJ Needed — Corporate Event", location: "Otjiwarongo", region: "Otjozondjupa", date: "Saturday", budget: "N$3000", category: "DJ", posted_by: "u_lukas", applicants: 3 },
  { id: "o3", title: "Model Casting — Fashion Week", location: "Swakopmund", region: "Erongo", date: "Next Week", budget: "N$800", category: "Model", posted_by: "u_sarah", applicants: 24 },
  { id: "o4", title: "Videographer — Music Video", location: "Windhoek", region: "Khomas", date: "Dec 15", budget: "N$5000", category: "Videographer", posted_by: "u_tangeni", applicants: 5 },
  { id: "o5", title: "Makeup Artist — Wedding Season", location: "Oshakati", region: "Oshana", date: "Ongoing", budget: "N$600/day", category: "Makeup Artist", posted_by: "u_ester", applicants: 12 },
];
