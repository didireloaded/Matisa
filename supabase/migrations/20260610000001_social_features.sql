...
-- Function to update post counts (likes, comments, reposts) - Optional but good for performance
-- In a real prod environment we might use materialized views or triggers.
